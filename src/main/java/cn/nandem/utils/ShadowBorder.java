...
/**
 * Instance can be retrieved via an overloading {@code newInstance()} method or
 * a {@code ShadowBorder.Builder} instance, using a "builder design pattern".
 * 
 ...
 * effect.
 * 
 * The dependency jar can be downloaded from the JHLabs website, or from the
 * maven central repository with the following POM coordination:
 * 
 * <pre>
 * {@code 
 * 
